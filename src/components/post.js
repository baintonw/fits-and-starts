...
const Post = (props) => {
    return(
          <div className="post" style={{transform: `translateX(${props.translateX}%)`}}>
              <div  className="post__left" style={{
